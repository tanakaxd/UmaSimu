class AbilityEru extends Ability{
    constructor(inherited) {
        ...
        this.activated_position = course.accum_dist_to_last_straight;
    }
    ...
    activate(uma) {
        ...
        if (uma.progression == PROGRESSION.LAST_STRAIGHT && uma.pos.x >= this.activated_position) {
