class Takamatsu extends Course{
    ...
    constructor() {
        ...
        this.last_straight_length = 400;
        this.final_corner_not_spurt_length = 250;
        this.final_corner_spurt_length = 0;
