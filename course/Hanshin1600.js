class Hanshin1600 extends Course{
    ...
    constructor() {
        ...
        this.third_corner_length = 350;
        this.final_corner_length = 327;
        this.last_straight_length = 473;
        this.final_corner_not_spurt_length = 267;
        this.final_corner_spurt_length = 60;
        this.third_corner_not_spurt_length = 300;
        this.third_corner_spurt_length = 0;
        this.second_half_length = this.race_distance / 2;

        //ある区間の開始地点座標。スタートは0。ゴールは1600
        ...
        //ある地点
        this.first_uphill = 1405;
        this.first_downhill = 950;

        this.standard_frame = 3671;//TODO
