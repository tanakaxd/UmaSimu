class Kyoto3200 extends Course{

    constructor() {
        super();

        //ある区間の長さ            
        this.race_distance = 3200;
        ...
        this.final_corner_length = 247;
        this.last_straight_length = 403;
        this.final_corner_not_spurt_length = 0;
        this.final_corner_spurt_length = this.final_corner_length - this.final_corner_not_spurt_length;
        this.third_corner_not_spurt_length = 0;
        this.third_corner_spurt_length = this.third_corner_length - this.third_corner_not_spurt_length;
        this.second_half_length = this.race_distance / 2;

        //ある区間の開始地点座標。スタートは0。ゴールは3200
        ...
        this.accum_dist_to_spurt = this.early_length + this.middle_length;//this.accum_dist_to_first_spurtと同じ
        this.accum_dist_to_third_corner = 2300;
        this.accum_dist_to_final_corner = this.accum_dist_to_third_corner + this.third_corner_length;//最終コーナー
        this.accum_dist_to_spurt_corner = 2300;//終盤コーナー
