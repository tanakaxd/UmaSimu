class February extends Course{
    ...
    constructor() {
        ...
        //ある区間の長さ            
        this.race_distance = 1600;
        this.simulated_distance = this.race_distance - start_pos;//序盤の200mは除外
        ...
        this.third_corner_length = 225;
        this.final_corner_length = 225;
        this.last_straight_length = 500;
        this.final_corner_not_spurt_length = 192;
        this.final_corner_spurt_length = 33;
        this.third_corner_not_spurt_length = 250;
        ...
        //ある地点
        this.first_uphill = 252;
        this.first_downhill = 236;

        this.standard_frame = 74307;//TODO
